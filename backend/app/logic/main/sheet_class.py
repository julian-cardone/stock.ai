...
import datetime
import os
from backend.app.logic.main.financial_data_class import FinancialData
import tempfile
...
class Sheet:
    ...
    def __init__(self, stock_model):
        ...
        self.file_path = os.path.join('/home/jcar/dev/projects/stock.ai/backend/app/model/main', 'model.xlsx')
